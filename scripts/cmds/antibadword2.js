...
⚠️ আপনি একজন গ্রুপ এডমিন / বট এডমিন।

🚫 গ্রুপে খারাপ ভাষা ব্যবহার করা ঠিক না।
...
⚡ আবার খারাপ ভাষা ব্যবহার করলে Remove করা হবে।`,
          tid
        );
      }
...
❌ ৩ বার গালিগালাজ করার কারণে আপনাকে গ্রুপ থেকে Remove করা হচ্ছে।`,
        tid,
...
❌ Bot needs admin permission to remove users.`,
              tid
            );
