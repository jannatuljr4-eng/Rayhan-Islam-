...
const sendChecking = await api.sendMessage("🥵  পোদ মারা হচ্ছে 💋, please wait...", threadID);
...
ctx.fillText("DEVELOPED BY:- 𝆠፝𝐒𝐈𝐘𝐀𝐌-𝐇𝐀𝐒𝐀𝐍", centerX, canvas.height - 95);
